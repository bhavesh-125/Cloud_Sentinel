...
function uploadFile() {
    ...
    // Disable the upload button and show "Uploading..."
    uploadBtn.disabled = true;
    uploadBtn.textContent = "Uploading...";

    // STEP 1: Get the latest file list from the server before uploading
    fetch(`${API_BASE}/list`, {
        method: "GET",
        headers: {
    ...
    .then(data => {
        ...
        if (existingFilenames.includes(file.name)) {
            ...
            uploadBtn.textContent = "⬆️ Upload"; // Re-enable the button
